...
impl ToolsClient {
    ...
    pub async fn list(
        &self,
        request: &AgentsToolsListQueryRequest,
    ...
    pub async fn get(
        &self,
        tool_id: &str,
        request: &AgentsToolsGetQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<ToolResponseModel, ApiError> {
        self.http_client
            .execute_request(
    ...
    pub async fn delete(
        &self,
        tool_id: &str,
        request: &AgentsToolsDeleteQueryRequest,
        options: Option<RequestOptions>,
