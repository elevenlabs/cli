...
export const TestView: React.FC<TestViewProps> = ({
  ...
  useEffect(() => {
    const startTests = async () => {
      try {
        const { getElevenLabsClient, runTestsOnAgentApi } = await import('../../shared/elevenlabs-api.js');
  ...
  useEffect(() => {
    ...
    const pollInterval = setInterval(async () => {
      try {
        const { getElevenLabsClient, getTestInvocationApi } = await import('../../shared/elevenlabs-api.js');
        const client = await getElevenLabsClient();
