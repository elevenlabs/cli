...
pub enum TemplateBooleanOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateBooleanOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateBooleanOutputFailureReason {
...
impl fmt::Display for TemplateBooleanOutputFailureReason {
