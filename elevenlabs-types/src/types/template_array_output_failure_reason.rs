...
pub enum TemplateArrayOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateArrayOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateArrayOutputFailureReason {
...
impl fmt::Display for TemplateArrayOutputFailureReason {
