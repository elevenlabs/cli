...
pub struct PromptAgentApiModelOutput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub built_in_tools: Option<BuiltInToolsOutput>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backup_llm_config: Option<PromptAgentApiModelOutputBackupLlmConfig>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tools: Option<Vec<PromptAgentApiModelOutputToolsItem>>,
}

impl PromptAgentApiModelOutput {
    pub fn builder() -> PromptAgentApiModelOutputBuilder {
        <PromptAgentApiModelOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PromptAgentApiModelOutputBuilder {
    ...
    built_in_tools: Option<BuiltInToolsOutput>,
    ...
    tools: Option<Vec<PromptAgentApiModelOutputToolsItem>>,
}

impl PromptAgentApiModelOutputBuilder {
    ...
    pub fn built_in_tools(mut self, value: BuiltInToolsOutput) -> Self {
    ...
    pub fn backup_llm_config(mut self, value: PromptAgentApiModelOutputBackupLlmConfig) -> Self {
    ...
    pub fn tools(mut self, value: Vec<PromptAgentApiModelOutputToolsItem>) -> Self {
        self.tools = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PromptAgentApiModelOutput`].
    pub fn build(self) -> Result<PromptAgentApiModelOutput, BuildError> {
        Ok(PromptAgentApiModelOutput {
            prompt: self.prompt,
            llm: self.llm,
