...
pub struct TurnConfigWorkflowOverride {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub soft_timeout_config: Option<SoftTimeoutConfigWorkflowOverride>,
}

impl TurnConfigWorkflowOverride {
    pub fn builder() -> TurnConfigWorkflowOverrideBuilder {
        <TurnConfigWorkflowOverrideBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TurnConfigWorkflowOverrideBuilder {
...
impl TurnConfigWorkflowOverrideBuilder {
    ...
    pub fn soft_timeout_config(mut self, value: SoftTimeoutConfigWorkflowOverride) -> Self {
        self.soft_timeout_config = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`TurnConfigWorkflowOverride`].
    pub fn build(self) -> Result<TurnConfigWorkflowOverride, BuildError> {
        Ok(TurnConfigWorkflowOverride {
