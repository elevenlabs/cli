...
pub struct ConversationConfigWorkflowOverrideInput {
...
impl ConversationConfigWorkflowOverrideInput {
    pub fn builder() -> ConversationConfigWorkflowOverrideInputBuilder {
        <ConversationConfigWorkflowOverrideInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationConfigWorkflowOverrideInputBuilder {
...
impl ConversationConfigWorkflowOverrideInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ConversationConfigWorkflowOverrideInput`].
    pub fn build(self) -> Result<ConversationConfigWorkflowOverrideInput, BuildError> {
        Ok(ConversationConfigWorkflowOverrideInput {
