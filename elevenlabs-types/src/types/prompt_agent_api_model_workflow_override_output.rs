...
pub struct PromptAgentApiModelWorkflowOverrideOutput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub built_in_tools: Option<BuiltInToolsWorkflowOverrideOutput>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backup_llm_config: Option<PromptAgentApiModelWorkflowOverrideOutputBackupLlmConfig>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tools: Option<Vec<PromptAgentApiModelWorkflowOverrideOutputToolsItem>>,
}

impl PromptAgentApiModelWorkflowOverrideOutput {
    pub fn builder() -> PromptAgentApiModelWorkflowOverrideOutputBuilder {
        <PromptAgentApiModelWorkflowOverrideOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PromptAgentApiModelWorkflowOverrideOutputBuilder {
    ...
    built_in_tools: Option<BuiltInToolsWorkflowOverrideOutput>,
    ...
    tools: Option<Vec<PromptAgentApiModelWorkflowOverrideOutputToolsItem>>,
}

impl PromptAgentApiModelWorkflowOverrideOutputBuilder {
    ...
    pub fn built_in_tools(mut self, value: BuiltInToolsWorkflowOverrideOutput) -> Self {
    ...
    pub fn backup_llm_config(mut self, value: PromptAgentApiModelWorkflowOverrideOutputBackupLlmConfig) -> Self {
    ...
    pub fn tools(mut self, value: Vec<PromptAgentApiModelWorkflowOverrideOutputToolsItem>) -> Self {
        self.tools = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PromptAgentApiModelWorkflowOverrideOutput`].
    pub fn build(self) -> Result<PromptAgentApiModelWorkflowOverrideOutput, BuildError> {
        Ok(PromptAgentApiModelWorkflowOverrideOutput {
            prompt: self.prompt,
            llm: self.llm,
