...
#[serde(tag = "type")]
#[non_exhaustive]
pub enum TemplateInputReference {
        #[serde(rename = "asset")]
        #[non_exhaustive]
        Asset {
            #[serde(flatten)]
...
impl TemplateInputReference {
    ...
    pub fn inline_base64(content_base64: String, mime_type: InlineBase64ReferenceMimeType) -> Self {
        Self::InlineBase64 { content_base64, mime_type }
    }

    pub fn voice(voice_id: String) -> Self {
        Self::Voice { voice_id }
    }
