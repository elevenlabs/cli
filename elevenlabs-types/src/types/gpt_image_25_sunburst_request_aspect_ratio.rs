...
pub enum GptImage25SunburstRequestAspectRatio {
    Auto,
    One1,
    Four5,
    Five4,
...
impl Serialize for GptImage25SunburstRequestAspectRatio {
...
impl<'de> Deserialize<'de> for GptImage25SunburstRequestAspectRatio {
...
impl fmt::Display for GptImage25SunburstRequestAspectRatio {
