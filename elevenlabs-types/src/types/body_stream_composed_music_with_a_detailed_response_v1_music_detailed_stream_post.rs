...
pub struct BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPost {
    /// A simple text prompt to generate a song from. Cannot be used in conjunction with `composition_plan`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prompt: Option<String>,
    /// A detailed composition plan to guide music generation. Cannot be used in conjunction with `prompt`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub composition_plan: Option<BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostCompositionPlan>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub model_id: Option<BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostModelId>,
...
impl BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPost {
    pub fn builder() -> BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostBuilder {
        <BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostBuilder {
    prompt: Option<String>,
    composition_plan: Option<BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostCompositionPlan>,
    music_length_ms: Option<i64>,
    model_id: Option<BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostModelId>,
    seed: Option<i64>,
...
impl BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostBuilder {
    pub fn prompt(mut self, value: impl Into<String>) -> Self {
        self.prompt = Some(value.into());
        self
    }

    pub fn composition_plan(mut self, value: BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostCompositionPlan) -> Self {
    ...
    pub fn model_id(mut self, value: BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPostModelId) -> Self {
    ...
    pub fn finetune_id(mut self, value: impl Into<String>) -> Self {
        self.finetune_id = Some(value.into());
        self
    }
    ...
    /// Consumes the builder and constructs a [`BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPost`].
    pub fn build(self) -> Result<BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPost, BuildError> {
        Ok(BodyStreamComposedMusicWithADetailedResponseV1MusicDetailedStreamPost {
            prompt: self.prompt,
