...
impl Serialize for ConversationErrorType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match self {
            ...
            Self::DependencyError => serializer.serialize_str("dependency_error"),
...
impl<'de> Deserialize<'de> for ConversationErrorType {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        match value.as_str() {
            ...
            "dependency_error" => Ok(Self::DependencyError),
...
impl fmt::Display for ConversationErrorType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::DependencyError => write!(f, "dependency_error"),
