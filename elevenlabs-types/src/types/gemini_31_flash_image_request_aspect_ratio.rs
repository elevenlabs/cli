...
pub enum Gemini31FlashImageRequestAspectRatio {
    Auto,
    One1,
    Two3,
    Three2,
...
impl Serialize for Gemini31FlashImageRequestAspectRatio {
...
impl<'de> Deserialize<'de> for Gemini31FlashImageRequestAspectRatio {
...
impl fmt::Display for Gemini31FlashImageRequestAspectRatio {
