...
pub struct McpServerConfigInput {
    ...
    pub url: McpServerConfigInputUrl,
    /// The secret token (Authorization header) stored as a workspace secret or in-place secret
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secret_token: Option<McpServerConfigInputSecretToken>,
    /// The headers included in the request
    #[serde(skip_serializing_if = "Option::is_none")]
    pub request_headers: Option<HashMap<String, McpServerConfigInputRequestHeadersValue>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub request_meta: Option<HashMap<String, McpServerConfigInputRequestMetaValue>>,
    /// Optional auth connection to use for authentication with this MCP server
    #[serde(skip_serializing_if = "Option::is_none")]
    pub auth_connection: Option<McpServerConfigInputAuthConnection>,
    #[serde(default)]
    pub name: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tool_config_overrides: Option<Vec<McpToolConfigOverrideInput>>,
...
impl McpServerConfigInput {
    pub fn builder() -> McpServerConfigInputBuilder {
        <McpServerConfigInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct McpServerConfigInputBuilder {
    ...
    url: Option<McpServerConfigInputUrl>,
    secret_token: Option<McpServerConfigInputSecretToken>,
    request_headers: Option<HashMap<String, McpServerConfigInputRequestHeadersValue>>,
    request_meta: Option<HashMap<String, McpServerConfigInputRequestMetaValue>>,
    auth_connection: Option<McpServerConfigInputAuthConnection>,
    name: Option<String>,
    ...
    tool_config_overrides: Option<Vec<McpToolConfigOverrideInput>>,
    disable_compression: Option<bool>,
}

impl McpServerConfigInputBuilder {
    ...
    pub fn url(mut self, value: McpServerConfigInputUrl) -> Self {
        self.url = Some(value);
        self
    }

    pub fn secret_token(mut self, value: McpServerConfigInputSecretToken) -> Self {
        self.secret_token = Some(value);
        self
    }

    pub fn request_headers(mut self, value: HashMap<String, McpServerConfigInputRequestHeadersValue>) -> Self {
        self.request_headers = Some(value);
        self
    }

    pub fn request_meta(mut self, value: HashMap<String, McpServerConfigInputRequestMetaValue>) -> Self {
        self.request_meta = Some(value);
        self
    }

    pub fn auth_connection(mut self, value: McpServerConfigInputAuthConnection) -> Self {
    ...
    pub fn tool_config_overrides(mut self, value: Vec<McpToolConfigOverrideInput>) -> Self {
    ...
    /// Consumes the builder and constructs a [`McpServerConfigInput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`url`](McpServerConfigInputBuilder::url)
    /// - [`name`](McpServerConfigInputBuilder::name)
    pub fn build(self) -> Result<McpServerConfigInput, BuildError> {
        Ok(McpServerConfigInput {
