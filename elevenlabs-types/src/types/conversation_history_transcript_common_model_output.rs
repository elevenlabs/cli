...
pub struct ConversationHistoryTranscriptCommonModelOutput {
    pub role: ConversationHistoryTranscriptCommonModelOutputRole,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tool_results: Option<Vec<ConversationHistoryTranscriptCommonModelOutputToolResultsItem>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ConversationHistoryTranscriptCommonModelOutput {
    pub fn builder() -> ConversationHistoryTranscriptCommonModelOutputBuilder {
        <ConversationHistoryTranscriptCommonModelOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationHistoryTranscriptCommonModelOutputBuilder {
    role: Option<ConversationHistoryTranscriptCommonModelOutputRole>,
    ...
    tool_results: Option<Vec<ConversationHistoryTranscriptCommonModelOutputToolResultsItem>>,
...
impl ConversationHistoryTranscriptCommonModelOutputBuilder {
    pub fn role(mut self, value: ConversationHistoryTranscriptCommonModelOutputRole) -> Self {
    ...
    pub fn tool_results(mut self, value: Vec<ConversationHistoryTranscriptCommonModelOutputToolResultsItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`ConversationHistoryTranscriptCommonModelOutput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`role`](ConversationHistoryTranscriptCommonModelOutputBuilder::role)
    /// - [`time_in_call_secs`](ConversationHistoryTranscriptCommonModelOutputBuilder::time_in_call_secs)
    pub fn build(self) -> Result<ConversationHistoryTranscriptCommonModelOutput, BuildError> {
        Ok(ConversationHistoryTranscriptCommonModelOutput {
