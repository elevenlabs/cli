...
#[serde(untagged)]
pub enum StartProcedureToolConfigProceduresValue {
        ProcedureVersionRef(ProcedureVersionRef),

        ProcedureDraftRef(ProcedureDraftRef),
}

impl StartProcedureToolConfigProceduresValue {
...
impl fmt::Display for StartProcedureToolConfigProceduresValue {
