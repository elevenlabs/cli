...
impl PhoneNumbersCreateRequestBody {
    pub fn twilio(phone_number: String, label: String, sid: String, token: String) -> Self {
        Self::Twilio { phone_number, label, supports_inbound: None, supports_outbound: None, agent_id: None, sid, token, account_auth_token: None, region_config: None, enable_sms: None }
    }
    ...
    pub fn twilio_with_supports_inbound(phone_number: String, label: String, supports_inbound: bool, supports_outbound: Option<bool>, agent_id: Option<String>, sid: String, token: String, account_auth_token: Option<String>, region_config: Option<RegionConfigRequest>, enable_sms: Option<bool>) -> Self {
        Self::Twilio { phone_number, label, supports_inbound: Some(supports_inbound), supports_outbound, agent_id, sid, token, account_auth_token, region_config, enable_sms }
    }

    pub fn twilio_with_supports_outbound(phone_number: String, label: String, supports_inbound: Option<bool>, supports_outbound: bool, agent_id: Option<String>, sid: String, token: String, account_auth_token: Option<String>, region_config: Option<RegionConfigRequest>, enable_sms: Option<bool>) -> Self {
        Self::Twilio { phone_number, label, supports_inbound, supports_outbound: Some(supports_outbound), agent_id, sid, token, account_auth_token, region_config, enable_sms }
    }

    pub fn twilio_with_agent_id(phone_number: String, label: String, supports_inbound: Option<bool>, supports_outbound: Option<bool>, agent_id: String, sid: String, token: String, account_auth_token: Option<String>, region_config: Option<RegionConfigRequest>, enable_sms: Option<bool>) -> Self {
        Self::Twilio { phone_number, label, supports_inbound, supports_outbound, agent_id: Some(agent_id), sid, token, account_auth_token, region_config, enable_sms }
    }

    pub fn twilio_with_account_auth_token(phone_number: String, label: String, supports_inbound: Option<bool>, supports_outbound: Option<bool>, agent_id: Option<String>, sid: String, token: String, account_auth_token: String, region_config: Option<RegionConfigRequest>, enable_sms: Option<bool>) -> Self {
        Self::Twilio { phone_number, label, supports_inbound, supports_outbound, agent_id, sid, token, account_auth_token: Some(account_auth_token), region_config, enable_sms }
    }

    pub fn twilio_with_region_config(phone_number: String, label: String, supports_inbound: Option<bool>, supports_outbound: Option<bool>, agent_id: Option<String>, sid: String, token: String, account_auth_token: Option<String>, region_config: RegionConfigRequest, enable_sms: Option<bool>) -> Self {
        Self::Twilio { phone_number, label, supports_inbound, supports_outbound, agent_id, sid, token, account_auth_token, region_config: Some(region_config), enable_sms }
    }

    pub fn twilio_with_enable_sms(phone_number: String, label: String, supports_inbound: Option<bool>, supports_outbound: Option<bool>, agent_id: Option<String>, sid: String, token: String, account_auth_token: Option<String>, region_config: Option<RegionConfigRequest>, enable_sms: bool) -> Self {
        Self::Twilio { phone_number, label, supports_inbound, supports_outbound, agent_id, sid, token, account_auth_token, region_config, enable_sms: Some(enable_sms) }
    }
