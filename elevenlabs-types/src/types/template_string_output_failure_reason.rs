...
pub enum TemplateStringOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateStringOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateStringOutputFailureReason {
...
impl fmt::Display for TemplateStringOutputFailureReason {
