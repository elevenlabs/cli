...
pub enum ProjectCreationMetaType {
    Blank,
    GeneratePodcast,
    AutoAssignVoices,
    DubVideo,
...
impl Serialize for ProjectCreationMetaType {
...
impl<'de> Deserialize<'de> for ProjectCreationMetaType {
...
impl fmt::Display for ProjectCreationMetaType {
