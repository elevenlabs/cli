...
pub struct ConversationInitiationClientDataInternal {
...
impl ConversationInitiationClientDataInternal {
    pub fn builder() -> ConversationInitiationClientDataInternalBuilder {
        <ConversationInitiationClientDataInternalBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationInitiationClientDataInternalBuilder {
...
impl ConversationInitiationClientDataInternalBuilder {
    ...
    pub fn tool_mock_config(mut self, value: OrchestratorToolMockBehaviorConfig) -> Self {
