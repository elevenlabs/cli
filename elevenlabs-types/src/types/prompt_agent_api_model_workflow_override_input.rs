...
pub struct PromptAgentApiModelWorkflowOverrideInput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub built_in_tools: Option<BuiltInToolsWorkflowOverrideInput>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rag: Option<RagConfigWorkflowOverrideInput>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backup_llm_config: Option<PromptAgentApiModelWorkflowOverrideInputBackupLlmConfig>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tools: Option<Vec<PromptAgentApiModelWorkflowOverrideInputToolsItem>>,
}

impl PromptAgentApiModelWorkflowOverrideInput {
    pub fn builder() -> PromptAgentApiModelWorkflowOverrideInputBuilder {
        <PromptAgentApiModelWorkflowOverrideInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PromptAgentApiModelWorkflowOverrideInputBuilder {
    ...
    built_in_tools: Option<BuiltInToolsWorkflowOverrideInput>,
    ...
    rag: Option<RagConfigWorkflowOverrideInput>,
    timezone: Option<String>,
    backup_llm_config: Option<PromptAgentApiModelWorkflowOverrideInputBackupLlmConfig>,
    cascade_timeout_seconds: Option<f64>,
    tools: Option<Vec<PromptAgentApiModelWorkflowOverrideInputToolsItem>>,
}

impl PromptAgentApiModelWorkflowOverrideInputBuilder {
    ...
    pub fn built_in_tools(mut self, value: BuiltInToolsWorkflowOverrideInput) -> Self {
    ...
    pub fn rag(mut self, value: RagConfigWorkflowOverrideInput) -> Self {
        self.rag = Some(value);
        self
    }
    ...
    pub fn backup_llm_config(mut self, value: PromptAgentApiModelWorkflowOverrideInputBackupLlmConfig) -> Self {
    ...
    pub fn tools(mut self, value: Vec<PromptAgentApiModelWorkflowOverrideInputToolsItem>) -> Self {
        self.tools = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PromptAgentApiModelWorkflowOverrideInput`].
    pub fn build(self) -> Result<PromptAgentApiModelWorkflowOverrideInput, BuildError> {
        Ok(PromptAgentApiModelWorkflowOverrideInput {
            prompt: self.prompt,
            llm: self.llm,
