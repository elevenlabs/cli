...
pub enum BytedanceSeedance2FastRequestResolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
...
impl Serialize for BytedanceSeedance2FastRequestResolution {
...
impl<'de> Deserialize<'de> for BytedanceSeedance2FastRequestResolution {
...
impl fmt::Display for BytedanceSeedance2FastRequestResolution {
