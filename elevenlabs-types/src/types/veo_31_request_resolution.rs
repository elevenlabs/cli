...
pub enum Veo31RequestResolution {
    SevenHundredTwentyP,
    OneThousandEightyP,
    FourK,
...
impl Serialize for Veo31RequestResolution {
...
impl<'de> Deserialize<'de> for Veo31RequestResolution {
...
impl fmt::Display for Veo31RequestResolution {
