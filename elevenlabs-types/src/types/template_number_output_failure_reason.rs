...
pub enum TemplateNumberOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateNumberOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateNumberOutputFailureReason {
...
impl fmt::Display for TemplateNumberOutputFailureReason {
