...
pub enum TextToDialogueCommitStrategy {
    Manual,
    Vad,
...
impl Serialize for TextToDialogueCommitStrategy {
...
impl<'de> Deserialize<'de> for TextToDialogueCommitStrategy {
...
impl fmt::Display for TextToDialogueCommitStrategy {
