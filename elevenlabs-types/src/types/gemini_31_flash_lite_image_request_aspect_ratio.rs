...
pub enum Gemini31FlashLiteImageRequestAspectRatio {
    Auto,
    One1,
    Two3,
    Three2,
...
impl Serialize for Gemini31FlashLiteImageRequestAspectRatio {
...
impl<'de> Deserialize<'de> for Gemini31FlashLiteImageRequestAspectRatio {
...
impl fmt::Display for Gemini31FlashLiteImageRequestAspectRatio {
