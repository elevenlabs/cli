...
pub struct BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPost {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub apply_text_normalization: Option<BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPostApplyTextNormalization>,
...
impl BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPost {
    pub fn builder() -> BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPostBuilder {
        <BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPostBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPostBuilder {
    ...
    seed: Option<i64>,
    apply_text_normalization: Option<BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPostApplyTextNormalization>,
...
impl BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPostBuilder {
    ...
    pub fn apply_text_normalization(mut self, value: BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPostApplyTextNormalization) -> Self {
    ...
    /// Consumes the builder and constructs a [`BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPost`].
    /// This method will fail if any of the following fields are not set:
    /// - [`inputs`](BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPostBuilder::inputs)
    pub fn build(self) -> Result<BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPost, BuildError> {
        Ok(BodyTextToDialogueMultiVoiceStreamingV1TextToDialogueStreamPost {
