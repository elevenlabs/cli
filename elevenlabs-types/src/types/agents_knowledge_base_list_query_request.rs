...
pub struct AgentsKnowledgeBaseListQueryRequest {
...
impl AgentsKnowledgeBaseListQueryRequest {
    pub fn builder() -> AgentsKnowledgeBaseListQueryRequestBuilder {
        <AgentsKnowledgeBaseListQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentsKnowledgeBaseListQueryRequestBuilder {
...
impl AgentsKnowledgeBaseListQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`AgentsKnowledgeBaseListQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`types`](AgentsKnowledgeBaseListQueryRequestBuilder::types)
    pub fn build(self) -> Result<AgentsKnowledgeBaseListQueryRequest, BuildError> {
        Ok(AgentsKnowledgeBaseListQueryRequest {
