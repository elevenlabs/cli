...
pub enum BytedanceSeedance2MiniRequestResolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
...
impl Serialize for BytedanceSeedance2MiniRequestResolution {
...
impl<'de> Deserialize<'de> for BytedanceSeedance2MiniRequestResolution {
...
impl fmt::Display for BytedanceSeedance2MiniRequestResolution {
