...
pub enum FinetunesCreateRequestModelId {
    MusicV1,
    MusicV2,
...
impl Serialize for FinetunesCreateRequestModelId {
...
impl<'de> Deserialize<'de> for FinetunesCreateRequestModelId {
...
impl fmt::Display for FinetunesCreateRequestModelId {
