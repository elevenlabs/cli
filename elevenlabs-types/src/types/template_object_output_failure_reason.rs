...
pub enum TemplateObjectOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateObjectOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateObjectOutputFailureReason {
...
impl fmt::Display for TemplateObjectOutputFailureReason {
