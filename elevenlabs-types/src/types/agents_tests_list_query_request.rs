...
pub struct AgentsTestsListQueryRequest {
...
impl AgentsTestsListQueryRequest {
    pub fn builder() -> AgentsTestsListQueryRequestBuilder {
        <AgentsTestsListQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AgentsTestsListQueryRequestBuilder {
...
impl AgentsTestsListQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`AgentsTestsListQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`types`](AgentsTestsListQueryRequestBuilder::types)
    pub fn build(self) -> Result<AgentsTestsListQueryRequest, BuildError> {
        Ok(AgentsTestsListQueryRequest {
            cursor: self.cursor,
