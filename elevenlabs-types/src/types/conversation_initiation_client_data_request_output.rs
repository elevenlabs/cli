...
pub struct ConversationInitiationClientDataRequestOutput {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub conversation_config_override: Option<ConversationConfigClientOverrideOutput>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ConversationInitiationClientDataRequestOutput {
    pub fn builder() -> ConversationInitiationClientDataRequestOutputBuilder {
        <ConversationInitiationClientDataRequestOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationInitiationClientDataRequestOutputBuilder {
    conversation_config_override: Option<ConversationConfigClientOverrideOutput>,
...
impl ConversationInitiationClientDataRequestOutputBuilder {
    pub fn conversation_config_override(mut self, value: ConversationConfigClientOverrideOutput) -> Self {
    ...
    /// Consumes the builder and constructs a [`ConversationInitiationClientDataRequestOutput`].
    pub fn build(self) -> Result<ConversationInitiationClientDataRequestOutput, BuildError> {
        Ok(ConversationInitiationClientDataRequestOutput {
