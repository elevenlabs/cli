...
pub struct TtsConversationalConfigWorkflowOverrideInput {
...
impl TtsConversationalConfigWorkflowOverrideInput {
    pub fn builder() -> TtsConversationalConfigWorkflowOverrideInputBuilder {
        <TtsConversationalConfigWorkflowOverrideInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TtsConversationalConfigWorkflowOverrideInputBuilder {
