...
pub struct WebhookToolConfigInput {
    #[serde(default)]
    pub name: String,
    ...
    #[serde(default)]
    pub api_schema: WebhookToolApiSchemaConfigInput,
...
impl WebhookToolConfigInput {
    pub fn builder() -> WebhookToolConfigInputBuilder {
        <WebhookToolConfigInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WebhookToolConfigInputBuilder {
    name: Option<String>,
    ...
    api_schema: Option<WebhookToolApiSchemaConfigInput>,
    follow_redirects: Option<bool>,
    follow_redirects_allowed_domains: Option<Vec<String>>,
}

impl WebhookToolConfigInputBuilder {
    ...
    pub fn api_schema(mut self, value: WebhookToolApiSchemaConfigInput) -> Self {
        self.api_schema = Some(value);
        self
    }
    ...
    /// Consumes the builder and constructs a [`WebhookToolConfigInput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](WebhookToolConfigInputBuilder::name)
    /// - [`description`](WebhookToolConfigInputBuilder::description)
    /// - [`api_schema`](WebhookToolConfigInputBuilder::api_schema)
    pub fn build(self) -> Result<WebhookToolConfigInput, BuildError> {
        Ok(WebhookToolConfigInput {
