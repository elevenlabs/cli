...
pub enum Gemini3ProImageRequestAspectRatio {
    Auto,
    One1,
    Two3,
    Three2,
...
impl Serialize for Gemini3ProImageRequestAspectRatio {
...
impl<'de> Deserialize<'de> for Gemini3ProImageRequestAspectRatio {
...
impl fmt::Display for Gemini3ProImageRequestAspectRatio {
