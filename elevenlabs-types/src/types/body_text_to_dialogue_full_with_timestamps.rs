...
pub struct BodyTextToDialogueFullWithTimestamps {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub apply_text_normalization: Option<BodyTextToDialogueFullWithTimestampsApplyTextNormalization>,
    ...
    #[serde(skip)]
    pub output_format: Option<TextToDialogueConvertWithTimestampsRequestOutputFormat>,
    /// When enable_logging is set to false zero retention mode will be used for the request. This will mean history features are unavailable for this request, including request stitching. Zero retention mode may only be used by enterprise customers.
    #[serde(skip)]
    pub enable_logging: Option<bool>,
}

impl BodyTextToDialogueFullWithTimestamps {
    pub fn builder() -> BodyTextToDialogueFullWithTimestampsBuilder {
        <BodyTextToDialogueFullWithTimestampsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BodyTextToDialogueFullWithTimestampsBuilder {
    ...
    seed: Option<i64>,
    apply_text_normalization: Option<BodyTextToDialogueFullWithTimestampsApplyTextNormalization>,
    previous_request_ids: Option<Vec<String>>,
    next_request_ids: Option<Vec<String>>,
    previous_text: Option<String>,
    future_text: Option<String>,
    output_format: Option<TextToDialogueConvertWithTimestampsRequestOutputFormat>,
    enable_logging: Option<bool>,
}

impl BodyTextToDialogueFullWithTimestampsBuilder {
    ...
    pub fn apply_text_normalization(mut self, value: BodyTextToDialogueFullWithTimestampsApplyTextNormalization) -> Self {
    ...
    pub fn output_format(mut self, value: TextToDialogueConvertWithTimestampsRequestOutputFormat) -> Self {
    ...
    /// Consumes the builder and constructs a [`BodyTextToDialogueFullWithTimestamps`].
    /// This method will fail if any of the following fields are not set:
    /// - [`inputs`](BodyTextToDialogueFullWithTimestampsBuilder::inputs)
    pub fn build(self) -> Result<BodyTextToDialogueFullWithTimestamps, BuildError> {
        Ok(BodyTextToDialogueFullWithTimestamps {
