...
pub enum TemplateAudioOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateAudioOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateAudioOutputFailureReason {
...
impl fmt::Display for TemplateAudioOutputFailureReason {
