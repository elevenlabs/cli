...
pub enum GptImage15RequestBackground {
    Transparent,
    Opaque,
    Auto,
...
impl Serialize for GptImage15RequestBackground {
...
impl<'de> Deserialize<'de> for GptImage15RequestBackground {
...
impl fmt::Display for GptImage15RequestBackground {
