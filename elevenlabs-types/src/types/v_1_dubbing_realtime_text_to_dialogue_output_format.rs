...
pub enum TextToDialogueOutputFormat {
    Pcm8000,
    Pcm16000,
    Pcm22050,
    Pcm24000,
...
impl Serialize for TextToDialogueOutputFormat {
...
impl<'de> Deserialize<'de> for TextToDialogueOutputFormat {
...
impl fmt::Display for TextToDialogueOutputFormat {
