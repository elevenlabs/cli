...
pub enum TemplateIntegerOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateIntegerOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateIntegerOutputFailureReason {
...
impl fmt::Display for TemplateIntegerOutputFailureReason {
