...
pub enum BytedanceSeedance2RequestAspectRatio {
    Auto,
    TwentyOne9,
    Sixteen9,
    Four3,
...
impl Serialize for BytedanceSeedance2RequestAspectRatio {
...
impl<'de> Deserialize<'de> for BytedanceSeedance2RequestAspectRatio {
...
impl fmt::Display for BytedanceSeedance2RequestAspectRatio {
