...
pub struct BodyTextToDialogueMultiVoiceV1TextToDialoguePost {
...
impl BodyTextToDialogueMultiVoiceV1TextToDialoguePost {
    pub fn builder() -> BodyTextToDialogueMultiVoiceV1TextToDialoguePostBuilder {
        <BodyTextToDialogueMultiVoiceV1TextToDialoguePostBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BodyTextToDialogueMultiVoiceV1TextToDialoguePostBuilder {
...
impl BodyTextToDialogueMultiVoiceV1TextToDialoguePostBuilder {
    ...
    pub fn output_format(mut self, value: TextToDialogueConvertRequestOutputFormat) -> Self {
    ...
    /// Consumes the builder and constructs a [`BodyTextToDialogueMultiVoiceV1TextToDialoguePost`].
    /// This method will fail if any of the following fields are not set:
    /// - [`inputs`](BodyTextToDialogueMultiVoiceV1TextToDialoguePostBuilder::inputs)
    pub fn build(self) -> Result<BodyTextToDialogueMultiVoiceV1TextToDialoguePost, BuildError> {
        Ok(BodyTextToDialogueMultiVoiceV1TextToDialoguePost {
