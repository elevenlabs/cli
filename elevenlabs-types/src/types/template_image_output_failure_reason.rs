...
pub enum TemplateImageOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateImageOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateImageOutputFailureReason {
...
impl fmt::Display for TemplateImageOutputFailureReason {
