...
#[serde(untagged)]
pub enum McpServerConfigUpdateRequestModelRequestMetaValue {
        String(String),
...
impl McpServerConfigUpdateRequestModelRequestMetaValue {
...
impl fmt::Display for McpServerConfigUpdateRequestModelRequestMetaValue {
