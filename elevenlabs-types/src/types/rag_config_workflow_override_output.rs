...
pub struct RagConfigWorkflowOverrideOutput {
...
impl RagConfigWorkflowOverrideOutput {
    pub fn builder() -> RagConfigWorkflowOverrideOutputBuilder {
        <RagConfigWorkflowOverrideOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RagConfigWorkflowOverrideOutputBuilder {
    enabled: Option<bool>,
...
impl RagConfigWorkflowOverrideOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`RagConfigWorkflowOverrideOutput`].
    pub fn build(self) -> Result<RagConfigWorkflowOverrideOutput, BuildError> {
        Ok(RagConfigWorkflowOverrideOutput {
