...
pub enum CreatifyAuroraRequestResolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
...
impl Serialize for CreatifyAuroraRequestResolution {
...
impl<'de> Deserialize<'de> for CreatifyAuroraRequestResolution {
...
impl fmt::Display for CreatifyAuroraRequestResolution {
