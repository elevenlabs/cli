...
pub enum TemplateVideoOutputFailureReason {
    Timeout,
    ModelError,
    Moderated,
    InvalidParameters,
...
impl Serialize for TemplateVideoOutputFailureReason {
...
impl<'de> Deserialize<'de> for TemplateVideoOutputFailureReason {
...
impl fmt::Display for TemplateVideoOutputFailureReason {
