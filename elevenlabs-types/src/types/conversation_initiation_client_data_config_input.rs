...
pub struct ConversationInitiationClientDataConfigInput {
    /// Overrides for the conversation configuration
    #[serde(skip_serializing_if = "Option::is_none")]
    pub conversation_config_override: Option<ConversationConfigClientOverrideConfigInput>,
...
impl ConversationInitiationClientDataConfigInput {
    pub fn builder() -> ConversationInitiationClientDataConfigInputBuilder {
        <ConversationInitiationClientDataConfigInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationInitiationClientDataConfigInputBuilder {
    conversation_config_override: Option<ConversationConfigClientOverrideConfigInput>,
...
impl ConversationInitiationClientDataConfigInputBuilder {
    pub fn conversation_config_override(mut self, value: ConversationConfigClientOverrideConfigInput) -> Self {
    ...
    /// Consumes the builder and constructs a [`ConversationInitiationClientDataConfigInput`].
    pub fn build(self) -> Result<ConversationInitiationClientDataConfigInput, BuildError> {
        Ok(ConversationInitiationClientDataConfigInput {
