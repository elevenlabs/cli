...
impl CreateRequest12 {
    pub fn builder() -> CreateRequest12Builder {
        <CreateRequest12Builder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateRequest12Builder {
    files: Option<Vec<Vec<u8>>>,
    remove_background_noise: Option<bool>,
}

impl CreateRequest12Builder {
    ...
    /// Consumes the builder and constructs a [`CreateRequest12`].
    /// This method will fail if any of the following fields are not set:
    /// - [`files`](CreateRequest12Builder::files)
    pub fn build(self) -> Result<CreateRequest12, BuildError> {
        Ok(CreateRequest12 {
