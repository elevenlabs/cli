...
pub enum GptImage25FlareRequestQuality {
    Low,
    Medium,
    High,
    Xhigh,
...
impl Serialize for GptImage25FlareRequestQuality {
...
impl<'de> Deserialize<'de> for GptImage25FlareRequestQuality {
...
impl fmt::Display for GptImage25FlareRequestQuality {
