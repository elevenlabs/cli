...
pub enum BytedanceSeedance2MiniRequestAspectRatio {
    Auto,
    TwentyOne9,
    Sixteen9,
    Four3,
...
impl Serialize for BytedanceSeedance2MiniRequestAspectRatio {
...
impl<'de> Deserialize<'de> for BytedanceSeedance2MiniRequestAspectRatio {
...
impl fmt::Display for BytedanceSeedance2MiniRequestAspectRatio {
