...
impl RagConfigInput {
    pub fn builder() -> RagConfigInputBuilder {
        <RagConfigInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RagConfigInputBuilder {
    enabled: Option<bool>,
...
impl RagConfigInputBuilder {
    ...
    /// Consumes the builder and constructs a [`RagConfigInput`].
    pub fn build(self) -> Result<RagConfigInput, BuildError> {
        Ok(RagConfigInput {
