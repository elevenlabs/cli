...
impl TestsUpdateRequestBody {
    ...
    pub fn simulation_with_from_conversation_metadata(from_conversation_metadata: TestFromConversationMetadataInput, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
    ...
    pub fn simulation_with_conversation_initiation_source(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: ConversationInitiationSource, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
    ...
    pub fn simulation_with_success_condition(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: String, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
        Self::Simulation { from_conversation_metadata, dynamic_variables, chat_history, conversation_initiation_source, success_condition: Some(success_condition), success_conditions, simulation_scenario, simulation_max_turns, simulation_environment, tool_mock_config, tool_mock_overrides, evaluation_model, simulated_user_model, name, parent_folder_id }
    }

    pub fn simulation_with_success_conditions(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Vec<String>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
        Self::Simulation { from_conversation_metadata, dynamic_variables, chat_history, conversation_initiation_source, success_condition, success_conditions: Some(success_conditions), simulation_scenario, simulation_max_turns, simulation_environment, tool_mock_config, tool_mock_overrides, evaluation_model, simulated_user_model, name, parent_folder_id }
    }

    pub fn simulation_with_simulation_scenario(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: String, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
        Self::Simulation { from_conversation_metadata, dynamic_variables, chat_history, conversation_initiation_source, success_condition, success_conditions, simulation_scenario: Some(simulation_scenario), simulation_max_turns, simulation_environment, tool_mock_config, tool_mock_overrides, evaluation_model, simulated_user_model, name, parent_folder_id }
    }

    pub fn simulation_with_simulation_max_turns(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: i64, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
    ...
    pub fn simulation_with_simulation_environment(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: String, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
    ...
    pub fn simulation_with_tool_mock_config(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: SimulationToolMockBehaviorConfig, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
    ...
    pub fn simulation_with_tool_mock_overrides(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: HashMap<String, Vec<ToolResponseMockConfigInput>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
    ...
    pub fn simulation_with_evaluation_model(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Llm, simulated_user_model: Option<Llm>, name: String, parent_folder_id: Option<String>) -> Self {
    ...
    pub fn simulation_with_simulated_user_model(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Llm, name: String, parent_folder_id: Option<String>) -> Self {
    ...
    pub fn simulation_with_parent_folder_id(from_conversation_metadata: Option<TestFromConversationMetadataInput>, dynamic_variables: Option<HashMap<String, serde_json::Value>>, chat_history: Option<Vec<ConversationHistoryTranscriptCommonModelInput>>, conversation_initiation_source: Option<ConversationInitiationSource>, success_condition: Option<String>, success_conditions: Option<Vec<String>>, simulation_scenario: Option<String>, simulation_max_turns: Option<i64>, simulation_environment: Option<String>, tool_mock_config: Option<SimulationToolMockBehaviorConfig>, tool_mock_overrides: Option<HashMap<String, Vec<ToolResponseMockConfigInput>>>, evaluation_model: Option<Llm>, simulated_user_model: Option<Llm>, name: String, parent_folder_id: String) -> Self {
