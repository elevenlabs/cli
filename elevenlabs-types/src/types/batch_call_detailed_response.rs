...
pub struct BatchCallDetailedResponse {
    #[serde(default)]
    pub id: String,
    ...
    #[serde(default)]
    pub recipients: Vec<OutboundCallRecipientResponseModel>,
}

impl BatchCallDetailedResponse {
    pub fn builder() -> BatchCallDetailedResponseBuilder {
        <BatchCallDetailedResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BatchCallDetailedResponseBuilder {
    id: Option<String>,
    ...
    recipients: Option<Vec<OutboundCallRecipientResponseModel>>,
}

impl BatchCallDetailedResponseBuilder {
    ...
    pub fn recipients(mut self, value: Vec<OutboundCallRecipientResponseModel>) -> Self {
        self.recipients = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`BatchCallDetailedResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](BatchCallDetailedResponseBuilder::id)
    /// - [`name`](BatchCallDetailedResponseBuilder::name)
    /// - [`agent_id`](BatchCallDetailedResponseBuilder::agent_id)
    /// - [`created_at_unix`](BatchCallDetailedResponseBuilder::created_at_unix)
    /// - [`scheduled_time_unix`](BatchCallDetailedResponseBuilder::scheduled_time_unix)
    /// - [`total_calls_dispatched`](BatchCallDetailedResponseBuilder::total_calls_dispatched)
    /// - [`total_calls_scheduled`](BatchCallDetailedResponseBuilder::total_calls_scheduled)
    /// - [`total_calls_finished`](BatchCallDetailedResponseBuilder::total_calls_finished)
    /// - [`last_updated_at_unix`](BatchCallDetailedResponseBuilder::last_updated_at_unix)
    /// - [`status`](BatchCallDetailedResponseBuilder::status)
    /// - [`retry_count`](BatchCallDetailedResponseBuilder::retry_count)
    /// - [`telephony_call_config`](BatchCallDetailedResponseBuilder::telephony_call_config)
    /// - [`agent_name`](BatchCallDetailedResponseBuilder::agent_name)
    /// - [`recipients`](BatchCallDetailedResponseBuilder::recipients)
    pub fn build(self) -> Result<BatchCallDetailedResponse, BuildError> {
        Ok(BatchCallDetailedResponse {
