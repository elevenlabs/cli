...
#[non_exhaustive]
pub enum SystemToolConfigOutputParams {
        ...
        EndProcedure {
            ...
            procedures: Option<HashMap<String, ProcedureAtVersionOutput>>,
        },
...
impl SystemToolConfigOutputParams {
    ...
    pub fn run_subagent(agents: Vec<SubAgentOutput>) -> Self {
    ...
    pub fn transfer_to_agent(transfers: Vec<AgentTransferOutput>) -> Self {
    ...
    pub fn end_procedure_with_procedures(procedures: HashMap<String, ProcedureAtVersionOutput>) -> Self {
        Self::EndProcedure { procedures: Some(procedures) }
    }

    pub fn start_procedure_with_procedures(procedures: HashMap<String, ProcedureAtVersionOutput>) -> Self {
