...
pub struct GenerationChunkOutput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub context_adherence: Option<GenerationChunkOutputContextAdherence>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub condition_strength: Option<GenerationChunkOutputConditionStrength>,
}

impl GenerationChunkOutput {
    pub fn builder() -> GenerationChunkOutputBuilder {
        <GenerationChunkOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GenerationChunkOutputBuilder {
    text: Option<String>,
    duration_ms: Option<i64>,
    positive_styles: Option<Vec<String>>,
    negative_styles: Option<Vec<String>>,
    context_adherence: Option<GenerationChunkOutputContextAdherence>,
    conditioning_ref: Option<AudioRefChunk>,
    condition_strength: Option<GenerationChunkOutputConditionStrength>,
}

impl GenerationChunkOutputBuilder {
    ...
    pub fn context_adherence(mut self, value: GenerationChunkOutputContextAdherence) -> Self {
    ...
    pub fn condition_strength(mut self, value: GenerationChunkOutputConditionStrength) -> Self {
        self.condition_strength = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`GenerationChunkOutput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`text`](GenerationChunkOutputBuilder::text)
    /// - [`duration_ms`](GenerationChunkOutputBuilder::duration_ms)
    /// - [`positive_styles`](GenerationChunkOutputBuilder::positive_styles)
    pub fn build(self) -> Result<GenerationChunkOutput, BuildError> {
        Ok(GenerationChunkOutput {
