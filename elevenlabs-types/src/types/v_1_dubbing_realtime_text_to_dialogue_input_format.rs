...
pub enum TextToDialogueInputFormat {
    Pcm8000,
    Pcm16000,
    Pcm22050,
    Pcm24000,
...
impl Serialize for TextToDialogueInputFormat {
...
impl<'de> Deserialize<'de> for TextToDialogueInputFormat {
...
impl fmt::Display for TextToDialogueInputFormat {
