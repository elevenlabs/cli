...
pub enum BytedanceSeedance2FastRequestAspectRatio {
    Auto,
    TwentyOne9,
    Sixteen9,
    Four3,
...
impl Serialize for BytedanceSeedance2FastRequestAspectRatio {
...
impl<'de> Deserialize<'de> for BytedanceSeedance2FastRequestAspectRatio {
...
impl fmt::Display for BytedanceSeedance2FastRequestAspectRatio {
