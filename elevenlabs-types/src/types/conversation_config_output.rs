...
pub struct ConversationConfigOutput {
...
impl ConversationConfigOutput {
    pub fn builder() -> ConversationConfigOutputBuilder {
        <ConversationConfigOutputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ConversationConfigOutputBuilder {
...
impl ConversationConfigOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ConversationConfigOutput`].
    pub fn build(self) -> Result<ConversationConfigOutput, BuildError> {
        Ok(ConversationConfigOutput {
