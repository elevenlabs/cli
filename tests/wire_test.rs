...
#[tokio::test]
async fn wire_replicate_to_isolated_environment() {
    run_case("replicate_to_isolated_environment").await;
}
...
#[tokio::test]
async fn wire_create_manual() {
    run_case("create_manual").await;
}
...
#[tokio::test]
async fn wire_add_comment() {
    run_case("add_comment").await;
}

#[tokio::test]
async fn wire_add_turn_comment() {
    run_case("add_turn_comment").await;
}
...
#[tokio::test]
async fn wire_list_v2() {
    run_case("list_v2").await;
}
...
#[tokio::test]
async fn wire_compile() {
    run_case("compile").await;
}
...
#[tokio::test]
async fn wire_update_segments() {
    run_case("update_segments").await;
}
...
#[tokio::test]
async fn wire_update_segments_1() {
    run_case("update_segments_1").await;
}
...
#[tokio::test]
async fn wire_delete_34() {
    run_case("delete_34").await;
}
...
#[tokio::test]
async fn wire_get_61() {
    run_case("get_61").await;
}
...
#[tokio::test]
async fn wire_create_48() {
    run_case("create_48").await;
}
...
#[tokio::test]
async fn wire_get_68() {
    run_case("get_68").await;
}
...
#[tokio::test]
async fn wire_list_47() {
    run_case("list_47").await;
}

#[tokio::test]
async fn wire_create_49() {
    run_case("create_49").await;
}

#[tokio::test]
async fn wire_delete_36() {
    run_case("delete_36").await;
}

#[tokio::test]
async fn wire_update_34() {
    run_case("update_34").await;
}

#[tokio::test]
async fn wire_list_48() {
    run_case("list_48").await;
}
...
#[tokio::test]
async fn wire_create_50() {
    run_case("create_50").await;
}
...
#[tokio::test]
async fn wire_delete_37() {
    run_case("delete_37").await;
}

#[tokio::test]
async fn wire_list_49() {
    run_case("list_49").await;
}

#[tokio::test]
async fn wire_update_35() {
    run_case("update_35").await;
}

#[tokio::test]
async fn wire_get_69() {
    run_case("get_69").await;
}
...
#[tokio::test]
async fn wire_get_70() {
    run_case("get_70").await;
}

#[tokio::test]
async fn wire_remove_3() {
    run_case("remove_3").await;
}
...
#[tokio::test]
async fn wire_replicate_to_isolated_environment_error() {
    run_case("replicate_to_isolated_environment_error").await;
}
...
#[tokio::test]
async fn wire_create_manual_error() {
    run_case("create_manual_error").await;
}
...
#[tokio::test]
async fn wire_add_comment_error() {
    run_case("add_comment_error").await;
}

#[tokio::test]
async fn wire_add_turn_comment_error() {
    run_case("add_turn_comment_error").await;
}
...
#[tokio::test]
async fn wire_list_v2_error() {
    run_case("list_v2_error").await;
}
...
#[tokio::test]
async fn wire_export_error() {
    run_case("export_error").await;
}
...
#[tokio::test]
async fn wire_compile_error() {
    run_case("compile_error").await;
}
...
#[tokio::test]
async fn wire_get_bulk_agents_error() {
    run_case("get_bulk_agents_error").await;
}
...
#[tokio::test]
async fn wire_bulk_delete_error() {
    run_case("bulk_delete_error").await;
}
...
#[tokio::test]
async fn wire_cancel_1_error() {
    run_case("cancel_1_error").await;
}
...
#[tokio::test]
async fn wire_update_segments_error() {
    run_case("update_segments_error").await;
}
...
#[tokio::test]
async fn wire_update_segments_1_error() {
    run_case("update_segments_1_error").await;
}
...
#[tokio::test]
async fn wire_delete_34_error() {
    run_case("delete_34_error").await;
}
...
#[tokio::test]
async fn wire_get_61_error() {
    run_case("get_61_error").await;
}
...
#[tokio::test]
async fn wire_create_48_error() {
    run_case("create_48_error").await;
}
...
#[tokio::test]
async fn wire_get_68_error() {
    run_case("get_68_error").await;
}
...
#[tokio::test]
async fn wire_list_47_error() {
    run_case("list_47_error").await;
}

#[tokio::test]
async fn wire_create_49_error() {
    run_case("create_49_error").await;
}

#[tokio::test]
async fn wire_delete_36_error() {
    run_case("delete_36_error").await;
}

#[tokio::test]
async fn wire_update_34_error() {
    run_case("update_34_error").await;
}

#[tokio::test]
async fn wire_list_48_error() {
    run_case("list_48_error").await;
}
...
#[tokio::test]
async fn wire_create_50_error() {
    run_case("create_50_error").await;
}
...
#[tokio::test]
async fn wire_delete_37_error() {
    run_case("delete_37_error").await;
}

#[tokio::test]
async fn wire_list_49_error() {
    run_case("list_49_error").await;
}

#[tokio::test]
async fn wire_update_35_error() {
    run_case("update_35_error").await;
}

#[tokio::test]
async fn wire_get_69_error() {
    run_case("get_69_error").await;
}
...
#[tokio::test]
async fn wire_get_70_error() {
    run_case("get_70_error").await;
}

#[tokio::test]
async fn wire_remove_3_error() {
    run_case("remove_3_error").await;
}
...
#[tokio::test]
async fn wire_create_30_optfileomitted() {
    run_case("create_30_optfileomitted").await;
}
...
#[tokio::test]
async fn wire_create_42_optfileomitted() {
    run_case("create_42_optfileomitted").await;
}

#[tokio::test]
async fn wire_update_29_optfileomitted() {
    run_case("update_29_optfileomitted").await;
}
